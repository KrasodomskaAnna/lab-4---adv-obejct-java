...
public class SymulatorWycieczki {
    ...
    private HashSet<SluchaczPostepow> sluchaczPostepow = new HashSet<>();

    public void dodajSluchacz(SluchaczPostepow s) {
        this.sluchaczPostepow.add(s);
    }
    ...
    public void bazowySluchacz(ElementWycieczki elementWycieczki, int lp, int
            liczbaElementow) {
        System.out.println(lp+"/"+liczbaElementow+" pkt postepu");
    }
    ...
    public void symuluj() {
        ...
        for(pozycjaGrupy = 0; pozycjaGrupy < wycieczka.getLiczbaElementowWycieczki(); pozycjaGrupy++) {
            ...
            if(elementWycieczki instanceof Atrakcja) {
                ...
                System.out.println("Grupa jest na atrakcji: "+atrakcja.getNazwa());
            ...
            for(SluchaczPostepow s : sluchaczPostepow) {
